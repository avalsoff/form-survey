...
function table1Row(nextId) {
  return `<tr> <td> ${nextId} </td> <td><input type="text" name="17_${nextId}"></td> <td> <select name="18_${nextId}"> <option value="ВО">ВО</option> <option value="СПО">СПО</option> <option value="НПО">НПО</option> </select> </td> <td><input type="text" name="19_${nextId}"></td> <td> <select name="20_${nextId}"> <option value="до 20000">До 20 000 руб.</option> <option value="от 20 000-30 000">20 001 - 30 000 руб.</option> <option value="от 20 000-30 000">30 001 - 40 000 руб.</option> <option value="от 20 000-30 000">40 001 - 60 000 руб.</option> <option value="от 20 000-30 000">60 001 - 80 000 руб.</option> <option value="от 20 000-30 000">80 001 - 100 000 руб.</option> <option value="от 20 000-30 000">более 100 000 руб.</option> </select> </td> <td><input type="text" name="21_${nextId}"></td> <td><input type="text" name="22_${nextId}"></td> <td><input type="text" name="23_${nextId}"></td> <td><input type="text" name="24_${nextId}"></td> </tr>`
}
